...
update() {
  ...
  // Suavizado del zoom
  if (this.zoomTarget === 1.0) {
  this.zoom += (1.0 - this.zoom) * 0.02; // regreso suave
}
...
onBeat() {
  this.zoom = 1.15;           // Zoom instantáneo
  this.zoomTarget = 1.0;      // Objetivo: volver a 1.0
  this.zoomCooldown = 0;      // Ya no necesitamos esperar para bajar
}
  getCharacter() {
    return this.char;
  }
