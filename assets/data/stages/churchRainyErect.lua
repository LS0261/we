function bg(t,f,x,y,sc,s,fo,a) sprite(t,'stages/church/erect/worship/'..f,x,y,sc,s,fo,a) end
...
function onCreate()
    ...
    sprite('lampLightC','stages/church/erect/parish/lampGlow',-800,-1000,0.9,0.6,true)
    sprite('lampLight2C','stages/church/erect/parish/lampGlow',500,-1000,0.9,0.6,true)
    ...
    sprite('lampLightB','stages/church/erect/parish/lampGlow',800,-1000,1.1,0.8,true)
    sprite('lampLight2B','stages/church/erect/parish/lampGlow',-1550,-1000,1.1,0.8,true)
    bg('ceilingLampA','ceilingLamp',1200,-1700,1.2,1,true)
    bg('ceilingLamp2A','ceilingLamp',-1900,-1700,1.2,1,true)
    sprite('lampLightA','stages/church/erect/parish/lampGlow',1050,-800,1.2,1,true)
    sprite('lampLightA','stages/church/erect/parish/lampGlow',-2050,-800,1.2,1,true)
    bg('gradient','worshipGradient',-2800,-1300,1.2,1,true)
end
