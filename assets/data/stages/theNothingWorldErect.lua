function bg(t,f,x,y,sc,s,fo,a) sprite(t,'stages/void/erect/'..f,x,y,sc,s,fo,a) end
function onCreate()
    bg('voidGradient','voidGradientErect',-1850,-2000,0.5)
    scaleObject('voidGradient',4,3)
    sprite('seleverPentagram','stages/void/seleverPentagram',-660,-600,1,0.8,false,true)
    setProperty('seleverPentagram.alpha',0.0001)
    setObjectOrder('seleverPentagram',getObjectOrder('dadGroup')-1)
    bg('rasazySignFragments','rasazySignFragments',-940,150,1.05,1,true)
    bg('rasazySign','rasazySign',-1020,-315,1,1,true)
end
