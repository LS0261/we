function bg(t,f,x,y,sc,s,fo,a) sprite(t,'stages/church/stormy/'..f,x,y,sc,s,fo,a) end
function anim(t,n,xml,fps,loop)
    addAnimationByPrefix(t,n,xml,fps,loop)
    playAnim(t,n,true)
end
function onCreate()
    bg('stormySky','stormySky',-2700,-1800,0.4)
    for i,e in pairs({'','Glow'}) do bg('moon'..(e:lower()),'zavodillaMoon'..e,-105,-1800,0.5) setProperty('moon'..(e:lower())..'.alpha',0.5) end for i = 1,2 do bg('clouds'..i,'clouds'..i,-2700,-1800,0.4) setProperty('clouds'..i..'.alpha',0.5) end for i = 1,2 do bg('backgroundFoliage'..i,'backgroundFoliage',i == 1 and -1450 or 500,-300,0.82) end
    for i = 1,2 do bg('backgroundFoliage'..i,'backgroundFoliage',i == 1 and -1450 or 500,-300,0.84,0.9) end
    --bg('stormyGradient','stormyGradient',-2800,-1700,1,2.2,true)
    ...
    anim('foliageLeftALT','idle','mini bush stormy instance 1',48,true)
    bg('foliageLeft','foliageLeft', -1700,-380,0.94,1,false,true)
    anim('foliageLeft','idle','mini bush stormy instance 1',48,true)
    bg('pathofPearl','pathofPearl',-2740,-180)
    bg('sakuraTree','sakuraTree',-2000,-1650,0.88,1.1,true,true)
    anim('sakuraTree','idle','sakuraTree stormty instance 1',24,true)
    bg('rightFoliage','rightFoliage', 510,-553,0.88,1.02,true,true)
    anim('rightFoliage','idle','large foliage stormy instance 1',24,true)
    ...
    bg('zavodillaGradient','zavodillaGradient',-2800,-1700,1,2.2,true)
    setProperty('zavodillaGradient.alpha',0.3)
end
